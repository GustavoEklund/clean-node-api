...
describe('Auth UseCase', () => {
  ...
  test('Should call Encrypter with correct values', async () => {
    ...
    await sut.auth('valid_email@mail.com', 'invalid_password')
    expect(encrypterSpy.password).toBe('invalid_password')
    expect(encrypterSpy.hashedPassword).toBe(loadUserByEmailRepositorySpy.user.password)
  })

  test('Should call TokenGenerator with correct with correct userId', async () => {
  ...
  test('Should call UpdateAccessTokenRepository with correct with correct values', async () => {
